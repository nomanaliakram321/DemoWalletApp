package com.nduwallet.sign.wallet
...
//                application = app,
//                useTls = true,
//                hostName = "relay.nduwallet.org",
//                projectId = "2ee94aca5d98e6c05c38bce02bee952a",
//                metadata = metadata
//            )
//            AuthClient.initialize(initParams)
//            val uri =
...
//
//            val delegate = object : AuthClient.WalletDelegate {
...
//            }
//
//            AuthClient.setWalletDelegate(delegate)
//            AuthClient.pair(pairingParams)
//        }
//    }
//
//    @Test
...
//            val pairingParams = WalletConnect.Params.Pair(uri)
//            val listener = object : AuthClient.WalletDelegate {
//                override fun onSessionProposal(sessionProposal: WalletConnect.Model.SessionProposal) {
//                    assert(true)
...
//
//                    AuthClient.approveSession(approveParams)
//                }
//
//                override fun onSessionRequest(sessionRequest: WalletConnect.Model.SessionRequest) {}
//                override fun onSessionDelete(deletedSession: WalletConnect.Model.DeletedSession) {}
...
//            }
//
//            AuthClient.setWalletDelegate(listener)
//            AuthClient.pair(pairingParams)
//        }
//    }
//
...
//
//                        AuthClient.upgrade(upgradeParams)
//                    }
//                }
//
//                override fun onSessionUpgradeResponse(response: WalletConnect.Model.SessionUpgradeResponse) {
...
//                        )
//
//                        AuthClient.emit(notificationParams)
//                    }
//                }
//
//                override fun onSessionUpgradeResponse(response: WalletConnect.Model.SessionUpgradeResponse) {}
...
//                        AuthClient.updateExpiry(extend)
//                    }
//                }
//
//                override fun onSessionUpgradeResponse(response: WalletConnect.Model.SessionUpgradeResponse) {}
