...
import com.nduwallet.wallet.ACCOUNTS_ARGUMENT_KEY
import com.nduwallet.wallet.R
import com.nduwallet.wallet.databinding.FragmentAccountsBinding
...
class AccountsFragment : Fragment(R.layout.fragment_accounts) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        findNavController().currentBackStackEntry?.savedStateHandle?.getLiveData<String>(ACCOUNTS_ARGUMENT_KEY)?.observe(viewLifecycleOwner) { pairingUri ->
            ...
            ///ToDo: This Function is used for Pairing a WC: to connect a chain
