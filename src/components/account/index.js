...
export const AccountDetailsContainer =(props) =>{
  const goBack = () => {
...
export const AccountLockContainer= (props) =>{
  const close = () => {
...
export const AccountUnlockContainer = (props)=> {
  const close = () => {
...
export const AccountSendContainer = (props) =>{
  const close = () => {
    props.navigation.navigate('AccountDetails', {
      wallet: props.wallet,
      account: props.account
...
export const AccountHistoryContainer= (props)=> {
  const goBack = () => {
    props.navigation.goBack()
  }
  return (
...
export const AccountTotalPanel =(props) =>{
