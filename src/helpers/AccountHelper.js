 ...
 */
 const setupNewUser = async (
  ...
  if (!user) {
    LogStore.log('Generating all keys from phrase given...',recoveryPhraseString,'App langiage', AppConstants.APP_LANGUAGE,)
    const seedBytes = await NativeModules.KeyaddrManager.keyaddrWordsToBytes(
    ...
    // console.log('recoveryPhraseAsBytes...',seedBytes)
