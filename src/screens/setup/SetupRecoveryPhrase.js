...
class SetupRecoveryPhrase extends Component {
  ...
  componentDidMount = () => {
    ...
    // }
    this.setState({
      recoveryPhrase:this.props.route.params?.recoveryPhrase
    },()=>{
      this.generateRecoveryPhrase()
    })
    console.log('props.......',this.state.recoveryPhrase,)
  }
...
this.setState({
  ...
  //     seeds
  //   )
  //   console.log('seed',seeds,'seed byte',seedBytes)
