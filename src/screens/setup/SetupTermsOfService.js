    ...
    this.setState({ spinner: true }, async () => {
      try {
        ...
        if (user) {
          ...
          console.log("console .. 6",  DataFormatHelper.convertRecoveryArrayToString(
            SetupStore.recoveryPhrase
          ),);
...
console.log(user,"after setup new user",  DataFormatHelper.convertRecoveryArrayToString(
  SetupStore.recoveryPhrase
),)
