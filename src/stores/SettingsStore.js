...
class SettingsStore {
  ...
  getApplicationNetworkSync = () => {
    console.log('getApplicationNetworkSync:()')
    return this._settings.applicationNetwork
  }

  getApplicationNetwork = async() => {
    console.log('getApplicationNetwork:()')
